...
public class ArcadeApp extends Application {
    ...
    public void start(Stage stage) {
        ...
        r.setOnMouseClicked(createMouseHandler(stage)); // clicks on the rectangle move it randomly
     ...
     */
    private EventHandler<? super MouseEvent> createMouseHandler(Stage stage) {
        return event -> {
            /*
            System.out.println(event);
