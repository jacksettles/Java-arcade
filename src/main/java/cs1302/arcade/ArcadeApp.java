...
public class ArcadeApp extends Application {
    ...
    /**
     * This method is simply made so that the asteroids do not start moving around
     * in AsteroidsGame until it has been instantiated and the scene has been swapped.
     */
